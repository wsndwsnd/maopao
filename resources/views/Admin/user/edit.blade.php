...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
       <form class="mws-form wzd-default wizard-form wizard-form-horizontal" action="/admin/user/{{ $data->id }}" method="post" enctype="multipart/form-data">
            ...
            <fieldset class="wizard-step mws-form-inline" data-wzd-id="wzd_1cejaah621r1815t3j2g_0" style="display: block;">
                ...
                <div id="" class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" name="user_name" class="required large" value="{{ $data->user_name }}" readonly>
                    </div>
                </div>
                <!-- <div class="mws-form-row">
                    <label class="mws-form-label">密码 <span class="required">*</span></label>
                    <div class="mws-form-item">
                        <input type="password" name="user_password" class="required email large">
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">确认密码 <span class="required">*</span></label>
                    <div class="mws-form-item">
                        <input type="password" name="user_repassword" class="required email large">
                    </div>
                </div> -->
                <div class="mws-form-row">
                    <label class="mws-form-label">e_mail <span class="required">*</span></label>
                    <div class="mws-form-item">
                        <input type="text" name="user_email" class="required email large" value="{{ $data->user_email }}">
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">手机号<span class="required">*</span></label>
                    <div class="mws-form-item">
                        <input type="text" name="user_tel" class="required email large" value="{{ $data->userinfo->user_tel or '' }}">
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">年龄<span class="required">*</span></label>
                    <div class="mws-form-item">
                        <input type="text" name="age" class="required email large"  value="{{ $data->userinfo->age or '' }}">
                    </div>
                </div>
                <div class="mws-form-row">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" name="birthday" class="required email large" value="{{ $data->userinfo->birthday or '' }}">
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">上传头像<span class="required">*</span></label>
                    <div class="mws-form-item" style="width:500px;height: 50px; "> 
                        <div style="float: left;margin-top: 15px;" >
                            <input type="file" name="img" class="required email large" style="width:500px;">
                        </div>
        ...
        <div class="mws-button-row"><input type="reset"  class="btn" value="重置"</button><button class="btn">修改</button></div>
    </form>
    </div>
</div>
@endsection
