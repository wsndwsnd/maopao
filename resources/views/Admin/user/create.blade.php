            ...
            <fieldset class="wizard-step mws-form-inline" data-wzd-id="wzd_1cejaah621r1815t3j2g_0" style="display: block;">
                ...
                <div id="" class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" name="user_name" class="required large" value="{{ old('user_name') }}">
                    </div>
                </div>
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" name="user_email" class="required email large" value="{{ old('user_email') }}">
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">手机号<span class="required">*</span></label>
                    <div class="mws-form-item">
                        <input type="text" name="user_tel" class="required email large" value="{{ old('user_tel') }}">
                    </div>
                </div>
                <div class="mws-form-row">
                    <label class="mws-form-label">年龄<span class="required">*</span></label>
                    <div class="mws-form-item">
                        <input type="text" name="age" class="required email large" value="{{ old('age') }}">
                    </div>
                </div>
                <div class="mws-form-row">
                ...
                <div class="mws-form-row">
                    ...
                    <div class="mws-form-item">
                        <input type="text" name="birthday" class="required email large" value="{{ old('birthday') }}">
                    </div>
                </div>
                <div class="mws-form-row">
