...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <head>
    ...
    <script type="text/javascript">var STYLEID = '16',
      ...
      defaultstyle = '',
      REPORTURL = 'aHR0cDovLzI5LjkyenliLmNvbS9wb3J0YWwucGhw',
      SITEURL = 'http://29.92zyb.com/',
      JSPATH = 'static/js/',
    ...
    <script language="javascript" type="text/javascript">function killErrors() {
        return true;
      }
    ...
    <meta name="msapplication-task" content="name=首页;action-uri=http://29.92zyb.com/portal.php;icon-uri=http://29.92zyb.com/static/image/common/portal.ico" />
    <meta name="msapplication-task" content="name=论坛;action-uri=http://29.92zyb.com/forum.php;icon-uri=http://29.92zyb.com/static/image/common/bbs.ico" />
    <meta name="msapplication-task" content="name=群组;action-uri=http://29.92zyb.com/group.php;icon-uri=http://29.92zyb.com/static/image/common/group.ico" />
    <script src="js/portal.js" type="text/javascript"></script>
    <script src="js/jquery-1.2.6.min.js" type="text/javascript"></script>
    <script type="text/javascript">var zhuanti = jQuery.noConflict();

      zhuanti(document).ready(function() {

        zhuanti('.syzttj li:first').addClass('active');

        zhuanti('.syzttj li').click(function() {

          zhuanti(this).addClass('active').siblings().removeClass('active');
        });

      });</script>
    <script type="text/javascript">var huiyuan = jQuery.noConflict();

      huiyuan(document).ready(function() {

        huiyuan('.ltsyhyph li:first').addClass('active');

        huiyuan('.ltsyhyph li').hover(function() {

          huiyuan(this).addClass('active').siblings().removeClass('active');
        });
  ...
  <body id="nv_portal" class="pg_index" onkeydown="if(event.keyCode==27) return false;">
    ...
    <ul id="myprompt_menu" class="p_pop" style="display: none;">
      <li>
        <a href="home.php?mod=space&amp;do=pm" id="pm_ntc" style="background-repeat: no-repeat; background-position: 0 50%;">
          <em class="prompt_news_0"></em>消息</a>
      </li>
      <li>
        <a href="home.php?mod=follow&amp;do=follower">
          <em class="prompt_follower_0"></em>新听众</a>
      </li>
      <li class="ignore_noticeli">
        <a href="javascript:;" onClick="setcookie('ignore_notice', 1);hideMenu('myprompt_menu')" title="暂不提醒">
          <em class="ignore_notice"></em>
        </a>
      </li>
    </ul>
    <ul id="myitem_menu" class="p_pop" style="display: none;">
      <li>
        <a href="forum.php?mod=guide&amp;view=my">帖子</a></li>
      <li>
        <a href="home.php?mod=space&amp;do=favorite&amp;view=me">收藏</a></li>
      <li>
        <a href="home.php?mod=space&amp;do=friend">好友</a></li>
    </ul>
    <div id="qmenu_menu" class="p_pop " style="display: none;">
      <ul class="cl nav">
        <li>
          <a href="home.php?mod=magic" style="background-image:url(images/magic_b.png) !important">道具</a></li>
        <li>
          <a href="home.php?mod=medal" style="background-image:url(images/medal_b.png) !important">勋章</a></li>
        <li>
          <a href="home.php?mod=task" style="background-image:url(images/task_b.png) !important">任务</a></li>
      </ul>
    ...
    <div id="wp_toptb_d" class="cl">
      <div class="wp cl">
        <div class="z">
          <a href="javascript:;" onclick="setHomepage('http://29.92zyb.com/');">设为首页</a>
          <span class="pipe">|</span>
          <a href="http://29.92zyb.com/" onclick="addFavorite(this.href, 'Discuz! Board');return false;">收藏本站</a></div>
        <div class="y">
          <a href="home.php?mod=space&amp;uid=14" class="wi_ttbat">
            <img src="picture/avatar.php" /></a>
          <a href="home.php?mod=space&amp;uid=14" class="top_gly" target="_blank" title="访问我的空间">123456</a>
          <a href="javascript:;" id="wqmenu" class="showmenu" onMouseOver="showMenu({'ctrlid':'wqmenu','pos':'34!','ctrlclass':'a','duration':2});">导航
            <span class="arrow"></span></a>
          <a href="home.php?mod=spacecp" class="u31">设置</a>
          <a href="javascript:;" id="wmn" class="showmenu " onMouseOver="showMenu({'ctrlid':'wmn','pos':'34!','ctrlclass':'a','duration':2});">消息</a>
          <a href="home.php?mod=space&amp;do=notice" id="myprompt">提醒</a>
          <span id="myprompt_check"></span>
          <a href="member.php?mod=logging&amp;action=logout&amp;formhash=316f8b52">退出</a></div>
      </div>
    </div>
    <!--快捷导航-->
    ...
    <ul id="wmn_menu" class="wi_pop" style="display: none;">
      <li>
        <a href="home.php?mod=space&amp;do=pm" id="pm_ntc">消息</a></li>
      <li>
        <a href="home.php?mod=follow&amp;do=follower" class="u31">新听众</a></li>
    </ul>
    <!--用户中心管理-->
    <ul id="wmod_menu" class="wi_pop" style="display: none;">
      <li>
        <a href="home.php?mod=spacecp" class="u31">个人设置</a></li>
    </ul>
    <!--切换风格-->
    <div id="wist_menu" class="wi_pop" style="display: none;">
      <ul class="wi_skin cl">
        <li onClick="extstyle('')" title="时尚酷黑">
          <i>
          </i>
        </li>
      </ul>
        ...
        <div class="hdc cl">
          <h2>
            <a href="./" title="Discuz! Board">
              <img src="picture/logo.png" alt="Discuz! Board" border="0" /></a>
          </h2>
          ...
          <ul id="scbar_type_menu" class="p_pop" style="display: none;">
            <li>
              <a href="javascript:;" rel="article">文章</a></li>
            <li>
              <a href="javascript:;" rel="forum" class="curtype">帖子</a></li>
            <li>
              <a href="javascript:;" rel="group">群组</a></li>
            <li>
            ...
            <div id="nv_a" class="wp">
              <ul>
                <li class="xnv_1 a xnv_a1" id="mn_portal">
                  <a href="portal.php" hidefocus="true" title="Portal">首页
                    <span>Portal</span></a>
                </li>
                ...
                <li class="xnv_3" id="mn_forum_10">
                  <a href="forum.php?mod=guide" hidefocus="true" title="Guide">导读
                    <span>Guide</span></a>
                </li>
                <li class="xnv_4" id="mn_P1" onmouseover="showMenu({'ctrlid':this.id,'ctrlclass':'hover','duration':2})">
                  <a href="http://29.92zyb.com/portal.php?mod=list&catid=1" hidefocus="true">资讯</a></li>
                <li class="xnv_5" id="mn_N326f">
                  <a href="forum.php?mod=forumdisplay&fid=41" hidefocus="true">瀑布流</a></li>
                <li class="xnv_6" id="mn_Nb2c4">
                  <a href="https://item.taobao.com/item.htm?id=549841050832" hidefocus="true" style="color: yellow">进入购买</a></li>
              </ul>
          ...
          <div id="um">
            <div class="avt y">
              <a href="home.php?mod=space&amp;uid=14">
                <img src="picture/avatar.php" /></a>
            </div>
            <p>
              <strong class="vwmy">
                <a href="home.php?mod=space&amp;uid=14" target="_blank" title="访问我的空间">123456</a></strong>
              <span class="pipe">|</span>
              <a href="javascript:;" id="myitem" class="showmenu" onmouseover="showMenu({'ctrlid':'myitem'});">我的</a>
              <span class="pipe">|</span>
              <a href="home.php?mod=spacecp">设置</a>
              <span class="pipe">|</span>
              <a href="home.php?mod=space&amp;do=pm" id="pm_ntc">消息</a>
              <span class="pipe">|</span>
              <a href="home.php?mod=space&amp;do=notice" id="myprompt" class="a showmenu" onmouseover="showMenu({'ctrlid':'myprompt'});">提醒</a>
              <span id="myprompt_check"></span>
              <span class="pipe">|</span>
              <a href="member.php?mod=logging&amp;action=logout&amp;formhash=316f8b52">退出</a></p>
            <p>
              <a href="home.php?mod=spacecp&amp;ac=credit&amp;showcredit=1" id="extcreditmenu" onmouseover="delayShow(this, showCreditmenu);" class="showmenu">积分: 8</a>
              <span class="pipe">|</span>
              <a href="home.php?mod=spacecp&amp;ac=usergroup" id="g_upmine" class="showmenu" onmouseover="delayShow(this, showUpgradeinfo)">用户组: 新手上路</a></p>
          </div>
        </div>
      </div>
      <ul class="p_pop h_pop" id="mn_forum_menu" style="display: none">
        <li>
          <a href="forum.php?mod=forumdisplay&fid=2" hidefocus="true">帖子列表页</a></li>
        <li>
          <a href="forum.php?mod=viewthread&tid=46" hidefocus="true">帖子内容页</a></li>
      </ul>
      <ul class="p_pop h_pop" id="mn_P1_menu" style="display: none">
        <li>
          <a href="portal.php?mod=list&catid=1" hidefocus="true">资讯列表页</a></li>
        <li>
          <a href="portal.php?mod=view&aid=12" hidefocus="true">文章内容页</a></li>
      </ul>
                      ...
                      <ul>
                        <li class="tupian">
                          <a href="forum.php?mod=viewthread&tid=100" target="_blank" title="发帖测试">
                            <img src="picture/172642my3xtstksrfrk333.png" width="390" height="248" alt="发帖测试" /></a>
                          <div class="sbover">
                  ...
                  <div id="portal_block_63_content" class="dxb_bc">
                    <div class="module cl xld">
                      <dl class="cl cc1">
                        <dd class="m">
                          <a href="forum.php?mod=viewthread&tid=100" target="_blank" title="发帖测试">
                            <img src="picture/aa3a58d29310c5eaee91d2d230828482.jpg" width="100" height="94" alt="发帖测试" /></a>
                        </dd>
                        <dt>
                      ...
                      <dl class="cl cc2">
                        <dd class="m">
                          <a href="forum.php?mod=viewthread&tid=89" target="_blank" title="欧式别墅设计 欧式别墅室内装修效果图">
                            <img src="picture/21076109b602ad8227eece63c2e34327.jpg" width="100" height="94" alt="欧式别墅设计 欧式别墅室内装修效果图" /></a>
                        </dd>
                        <dt>
                      ...
                      <dl class="cl cc3">
                        <dd class="m">
                          <a href="forum.php?mod=viewthread&tid=88" target="_blank" title="别墅室内装修软装设计需要注意哪些">
                            <img src="picture/16f89160772fbcc92adc863a5e3f8d1a.jpg" width="100" height="94" alt="别墅室内装修软装设计需要注意哪些" /></a>
                        </dd>
                        <dt>
                      ...
                      <dl class="cl">
                        <dd class="m">
                          <a href="home.php?mod=space&uid=12" c="1" target="_blank">
                            <img src="picture/avatar.php" width="52" height="52" alt="fff" /></a>
                        </dd>
                      ...
                      <dl class="cl">
                        <dd class="m">
                          <a href="home.php?mod=space&uid=1" c="1" target="_blank">
                            <img src="picture/avatar.php" width="52" height="52" alt="admin" /></a>
                        </dd>
                        <dt style="padding-bottom: 0;">
                          <a href="forum.php?mod=viewthread&tid=95" title="【加田小店】新锐创想轻主题模板活动演示帖[广州市]" target="_blank">【加田小店】新锐创想轻主题模板活动演示帖</a></dt>
                        <dd style="margin-bottom: 0;">
                  ...
                  <div id="portal_block_66_content" class="dxb_bc">
                    <div class="module cl xld slidebox" slidenum="8" slidestep="8">
                      <div class="slideshow">
                        <dl class="cl">
                          <dd class="m">
                            <a href="portal.php?mod=view&aid=12" title="昆凌称结婚签字像过家家 羞曝如何抓住周董心" target="_blank">
                              <img src="picture/a7a2ce7d3f9d4f86cb7573657b818259.jpg" width="266" height="180" alt="昆凌称结婚签字像过家家 羞曝如何抓住周董心" /></dd>
                          <dt class="leftjl">
                        ...
                        <dl class="cl">
                          <dd class="m">
                            <a href="portal.php?mod=view&aid=11" title="孙菲菲晒素颜自拍照 自称胖12斤丰满上围抢镜" target="_blank">
                              <img src="picture/71d5eb50b05b0e9989cf8aa8d24d4112.jpg" width="266" height="180" alt="孙菲菲晒素颜自拍照 自称胖12斤丰满上围抢镜" /></dd>
                          <dt class="leftjl">
                            <a href="portal.php?mod=view&aid=11" title="孙菲菲晒素颜自拍照 自称胖12斤丰满上围抢镜" target="_blank">孙菲菲晒素颜自拍照 自称胖12斤丰满上围抢</a></dt>
                          <dd class="xinx leftjl">
                            <span class="fbtime">
                              <i>
                              </i>2016-04-15</span>
                          ...
                          <dd class="rdmore leftjl">
                            <a href="portal.php?mod=view&aid=11" title="孙菲菲晒素颜自拍照 自称胖12斤丰满上围抢镜" target="_blank">read more</a></dd>
                        </dl>
                        <dl class="cl">
                          <dd class="m">
                            <a href="portal.php?mod=view&aid=10" title="婚姻感言只因是女子" target="_blank">
                              <img src="picture/d52cdeb621bc4c448570ce6ceea9158b.jpg" width="266" height="180" alt="婚姻感言只因是女子" /></dd>
                          <dt class="leftjl">
                            <a href="portal.php?mod=view&aid=10" title="婚姻感言只因是女子" target="_blank">婚姻感言只因是女子</a></dt>
                          <dd class="xinx leftjl">
                            <span class="fbtime">
                              <i>
                              </i>2016-04-15</span>
                          ...
                          <dd class="rdmore leftjl">
                            <a href="portal.php?mod=view&aid=10" title="婚姻感言只因是女子" target="_blank">read more</a></dd>
                        </dl>
                        <dl class="cl">
                          <dd class="m">
                            <a href="portal.php?mod=view&aid=9" title="我的日记-我不想长大" target="_blank">
                              <img src="picture/17da7ad0b06a176d4ed40b3d1798d8f5.jpg" width="266" height="180" alt="我的日记-我不想长大" /></dd>
                          <dt class="leftjl">
                            <a href="portal.php?mod=view&aid=9" title="我的日记-我不想长大" target="_blank">我的日记-我不想长大</a></dt>
                          <dd class="xinx leftjl">
                            <span class="fbtime">
                              <i>
                              </i>2016-04-15</span>
                          ...
                          <dd class="rdmore leftjl">
                            <a href="portal.php?mod=view&aid=9" title="我的日记-我不想长大" target="_blank">read more</a></dd>
                        </dl>
                        <dl class="cl">
                          <dd class="m">
                            <a href="portal.php?mod=view&aid=8" title="在三亚，我陪老婆一起来晒晒幸福！" target="_blank">
                              <img src="picture/de90c5ca6e02afdefb95aa0a48e23481.jpg" width="266" height="180" alt="在三亚，我陪老婆一起来晒晒幸福！" /></dd>
                          <dt class="leftjl">
                            <a href="portal.php?mod=view&aid=8" title="在三亚，我陪老婆一起来晒晒幸福！" target="_blank">在三亚，我陪老婆一起来晒晒幸福！</a></dt>
                          <dd class="xinx leftjl">
                            <span class="fbtime">
                              <i>
                              </i>2016-04-15</span>
                          ...
                          <dd class="rdmore leftjl">
                            <a href="portal.php?mod=view&aid=8" title="在三亚，我陪老婆一起来晒晒幸福！" target="_blank">read more</a></dd>
                        </dl>
                        <dl class="cl">
                          <dd class="m">
                            <a href="portal.php?mod=view&aid=7" title="胖子也有春天 如果胖请认真胖" target="_blank">
                              <img src="picture/73c7044f9bfb2e2015d3bf54d4d43a51.jpg" width="266" height="180" alt="胖子也有春天 如果胖请认真胖" /></dd>
                          <dt class="leftjl">
                            <a href="portal.php?mod=view&aid=7" title="胖子也有春天 如果胖请认真胖" target="_blank">胖子也有春天 如果胖请认真胖</a></dt>
                          <dd class="xinx leftjl">
                            <span class="fbtime">
                              <i>
                              </i>2016-04-15</span>
                          ...
                          <dd class="rdmore leftjl">
                            <a href="portal.php?mod=view&aid=7" title="胖子也有春天 如果胖请认真胖" target="_blank">read more</a></dd>
                        </dl>
                        <dl class="cl">
                          <dd class="m">
                            <a href="portal.php?mod=view&aid=6" title="辣妈马伊俐俏皮拍时尚大片凸显匀称好身材" target="_blank">
                              <img src="picture/267ace61bacd0f337edb74f63ae66142.jpg" width="266" height="180" alt="辣妈马伊俐俏皮拍时尚大片凸显匀称好身材" /></dd>
                          <dt class="leftjl">
                            <a href="portal.php?mod=view&aid=6" title="辣妈马伊俐俏皮拍时尚大片凸显匀称好身材" target="_blank">辣妈马伊俐俏皮拍时尚大片凸显匀称好身材</a></dt>
                          <dd class="xinx leftjl">
                            <span class="fbtime">
                              <i>
                              </i>2016-04-15</span>
                          ...
                          <dd class="rdmore leftjl">
                            <a href="portal.php?mod=view&aid=6" title="辣妈马伊俐俏皮拍时尚大片凸显匀称好身材" target="_blank">read more</a></dd>
                        </dl>
                        <dl class="cl">
                          <dd class="m">
                            <a href="portal.php?mod=view&aid=5" title="曾经深深认为男人确实不会有日久生情" target="_blank">
                              <img src="picture/3604fce8c130b85cf867ab33f941e516.jpg" width="266" height="180" alt="曾经深深认为男人确实不会有日久生情" /></dd>
                          <dt class="leftjl">
                            <a href="portal.php?mod=view&aid=5" title="曾经深深认为男人确实不会有日久生情" target="_blank">曾经深深认为男人确实不会有日久生情</a></dt>
                          <dd class="xinx leftjl">
                            <span class="fbtime">
                              <i>
                              </i>2016-04-15</span>
                          ...
                          <dd class="rdmore leftjl">
                            <a href="portal.php?mod=view&aid=5" title="曾经深深认为男人确实不会有日久生情" target="_blank">read more</a></dd>
                        </dl>
                        <dl class="cl">
                          <dd class="m">
                            <a href="portal.php?mod=view&aid=4" title="打造赫本式夏日优雅 快来试试阔摆裙" target="_blank">
                              <img src="picture/cf41ecaf3a0e0b76f139cc58b56bcaf0.jpg" width="266" height="180" alt="打造赫本式夏日优雅 快来试试阔摆裙" /></dd>
                          <dt class="leftjl">
                            <a href="portal.php?mod=view&aid=4" title="打造赫本式夏日优雅 快来试试阔摆裙" target="_blank">打造赫本式夏日优雅 快来试试阔摆裙</a></dt>
                          <dd class="xinx leftjl">
                            <span class="fbtime">
                              <i>
                              </i>2016-04-15</span>
                          ...
                          <dd class="rdmore leftjl">
                            <a href="portal.php?mod=view&aid=4" title="打造赫本式夏日优雅 快来试试阔摆裙" target="_blank">read more</a></dd>
                        </dl>
                        <dl class="cl">
                          <dd class="m">
                            <a href="portal.php?mod=view&aid=3" title="张天爱的装扮太easy 我有点不好意思美得这么不费力" target="_blank">
                              <img src="picture/eca5ac44f30da61c42c375af3d9387b3.jpg" width="266" height="180" alt="张天爱的装扮太easy 我有点不好意思美得这么不费力" /></dd>
                          <dt class="leftjl">
                            <a href="portal.php?mod=view&aid=3" title="张天爱的装扮太easy 我有点不好意思美得这么不费力" target="_blank">张天爱的装扮太easy 我有点不好意思美得这</a></dt>
                          <dd class="xinx leftjl">
                            <span class="fbtime">
                              <i>
                              </i>2016-04-15</span>
                          ...
                          <dd class="rdmore leftjl">
                            <a href="portal.php?mod=view&aid=3" title="张天爱的装扮太easy 我有点不好意思美得这么不费力" target="_blank">read more</a></dd>
                        </dl>
                        <dl class="cl">
                          <dd class="m">
                            <a href="portal.php?mod=view&aid=2" title="毛新宇：长沙给我留下许多深刻的印象" target="_blank">
                              <img src="picture/e2382dc7024c221d2198f11fb69d8a61.jpg" width="266" height="180" alt="毛新宇：长沙给我留下许多深刻的印象" /></dd>
                          <dt class="leftjl">
                            <a href="portal.php?mod=view&aid=2" title="毛新宇：长沙给我留下许多深刻的印象" target="_blank">毛新宇：长沙给我留下许多深刻的印象</a></dt>
                          <dd class="xinx leftjl">
                            <span class="fbtime">
                              <i>
                              </i>2016-04-15</span>
                          ...
                          <dd class="rdmore leftjl">
                            <a href="portal.php?mod=view&aid=2" title="毛新宇：长沙给我留下许多深刻的印象" target="_blank">read more</a></dd>
                        </dl>
                        <dl class="cl">
                          <dd class="m">
                            <a href="portal.php?mod=view&aid=1" title="朝鲜试图发射导弹未能成功" target="_blank">
                              <img src="picture/c4f1dc3018ae7762edf4937ddd17bfd4.jpg" width="266" height="180" alt="朝鲜试图发射导弹未能成功" /></dd>
                          <dt class="leftjl">
                            <a href="portal.php?mod=view&aid=1" title="朝鲜试图发射导弹未能成功" target="_blank">朝鲜试图发射导弹未能成功</a></dt>
                          <dd class="xinx leftjl">
                            <span class="fbtime">
                              <i>
                              </i>2016-04-15</span>
                          ...
                          <dd class="rdmore leftjl">
                            <a href="portal.php?mod=view&aid=1" title="朝鲜试图发射导弹未能成功" target="_blank">read more</a></dd>
                        </dl>
                      </div>
                      <div class="btn">
                        ...
                        <li class="tupian">
                          <div class="tutu">
                            <a href="forum.php?mod=viewthread&tid=101" target="_blank" title="123123123">
                              <img src="picture/nophoto.gif" width="290" height="194" alt="123123123" /></a>
                            <div class="sbover">
                      ...
                      <ul>
                        <li style="width: 292px;">
                          ...
                          <a class="tupian" href="forum.php?mod=viewthread&tid=65" target="_blank" title="狗狗吹泡泡，像个小孩一样去玩耍">
                            <img src="picture/be77bef5a40880366ec994b603e7400d.jpg" width="292" height="180" alt="狗狗吹泡泡，像个小孩一样去玩耍" /></a>
                        </li>
                        <li style="width: 292px;">
                          <p>别用这种眼神盯着我看，给你秀</p>
                          <a class="tupian" href="forum.php?mod=viewthread&tid=64" target="_blank" title="别用这种眼神盯着我看，给你秀秀就是了！">
                            <img src="picture/564b0ec04e980650d9acb8284626a0aa.jpg" width="292" height="180" alt="别用这种眼神盯着我看，给你秀秀就是了！" /></a>
                        </li>
                        <li style="width: 292px;">
                          <p>如何阻止喜马拉雅猫在家里搞破</p>
                          <a class="tupian" href="forum.php?mod=viewthread&tid=63" target="_blank" title="如何阻止喜马拉雅猫在家里搞破坏?">
                            <img src="picture/f7162616e6147225e51fd9715df5c392.jpg" width="292" height="180" alt="如何阻止喜马拉雅猫在家里搞破坏?" /></a>
                        </li>
                        <li style="width: 292px;">
                          <p>怎样正确的调教美国短毛猫?</p>
                          <a class="tupian" href="forum.php?mod=viewthread&tid=62" target="_blank" title="怎样正确的调教美国短毛猫?">
                            <img src="picture/22d5806bfaf311cfe5ea4c1332293a55.jpg" width="292" height="180" alt="怎样正确的调教美国短毛猫?" /></a>
                        </li>
                      </ul>
                    </div>
                  </div>
            ...
            <div id="gll">
              <div id="gywm">
                <ul>
                  ...
                  <li>
                    <a href="www.tmd9.com">网站简介</a></li>
                  <li>
                    <a href="www.tmd9.com">付费推广</a></li>
                  <li>
                    <a href="#">合作联盟</a></li>
                </ul>
              </div>
        ...
        <div id="ft" class=" cl">
          <div id="flk" style="display:none;">
            <p>Copyright &copy; 2001-2015
              <a href="#" target="_blank">www.tmd9.com</a>All Rights Reserved
              <a href="#" target="_blank">京 ICP备11000000号－4</a></p>
            <p>
              ...
              <span class="pipe">|</span>
              <a href="http://www.comsenz.com/" target="_blank">Comsenz Inc.</a></p>
          </div>
          <div id="ftl">
            <p>Powered by
              <a href="http://www.tmd9.com" target="_blank">Discuz!</a>
              <em>X3.4</em>Copyright
              <br />&copy; 2001-2013
              <a href="http://www.tmd9.com" target="_blank">www.tmd9.com Inc.</a></p>
          </div>
          <div id="frt">
            <p>
              <a href="javascript:;" onclick="showWindow('miscreport', 'misc.php?mod=report&url='+REPORTURL);return false;">举报</a>
              ...
              <span class="pipe">|</span>
              <a href="http://www.comsenz.com/" target="_blank">Comsenz Inc.</a></p>
            <p>GMT+8, 2018-5-26 15:47 , Processed in 1.078125 second(s), 9 queries.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <!--<div id="scrolltop"> 
    <span hidefocus="true"><a title="返回顶部" onclick="window.scrollTo('0','0')" class="scrolltopa" ><b>返回顶部</b></a></span></div>
    -->
    <div id="scrolltop">
      <ul>
        <!--<li><a href="javascript:void(0)" title="设为首页" onclick="setHomepage(window.location);" class="set_home"><span>设为首页</span></a></li>-->
        <li>
          <a href="javascript:void(0)" title="返回顶部" onclick="window.scrollTo('0','0')" class="scroll_top">
            <span>返回顶部</span></a>
        </li>
        <li>
          <a href="portal.php#wd_home7" title="生活" class="scroll_news">
            <span>生活</span></a>
        </li>
        <li>
          <a href="portal.php#wd_home3" title="轻松" class="scroll_pic">
            <span>轻松</span></a>
        </li>
        <li>
          <a href="javascript:void(0)" title="设为首页" onclick="setHomepage(window.location);" class="set_home">
            <span>设为首页</span></a>
        </li>
      </ul>
    </div>
    <script type="text/javascript">_attachEvent(window, 'scroll',
      function() {
        showTopLink();
      });
      checkBlind();</script>
