...
<td class="tipcol"><i  style="color:;">请填写3-6位 合法的用户名</i></td>
</tr>
</tbody></table>
</div>
...
<td class="tipcol"><i style="">请填写密码,长度为6-18位</i></td>
</tr>
</tbody></table>
</div>
...
<td><input type="password" class="px" name="repassword"></td>
<td class="tipcol"><i style="">请输入确认密码</i></td>
...
<table>
<tbody><tr>
<th><span class="rq">*</span><label for="">Email:</label></th>
<td><input type="text" class="px" name="email"></td>

<td class="tipcol"><i style="">请输入正确的邮箱地址</i></td>
</tr>
</tbody></table>
</div>
</div>
